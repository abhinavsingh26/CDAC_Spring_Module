...
public class ServiceImplementation implements ServiceInf {
	...
	//hey I want to call this function from python or javsacript or .net. .forget it we cant call it
	//with the current design.once we put http cover on top of this functgion then we call
	//it rom python or from .net..
